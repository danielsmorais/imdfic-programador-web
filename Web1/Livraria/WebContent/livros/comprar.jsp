		...
		<p>Para efetuar a compra dos livros selecionados, informe os seguintes dados:<c:url var="url" value="/livros/recibo"/>
		...
		<form id="form"action="${url}" method="post">
			<table summary="layout">
				...
				<tr>
					...
					<td><input type="text" name="cardnum" id="cardnum" onfocus="limparCartao()"	value="xxxx.xxxx.xxxx.xxxx" size="16"></td>
				</tr>
